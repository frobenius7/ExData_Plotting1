...
#we adjusted: main label, color of columns and the label of x axis
hist(hpcf$Global_active_power, main="Global Active Power", col="Red", xlab="Global Active Power (kilowatts)")
